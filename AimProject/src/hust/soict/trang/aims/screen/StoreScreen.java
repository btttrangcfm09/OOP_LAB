...
public class StoreScreen extends JFrame{
	...
	public class MediaStore extends JPanel {
	    ...
	    public MediaStore(Media media) {
	        ...
	        btnAddToCart.addActionListener(new ButtonListener(media, cart)); // Truyền Media và Cart
	        container.add(btnAddToCart);

	        if (media instanceof Playable) {
	            JButton btnPlay = new JButton("Play");
	            btnPlay.addActionListener(new ButtonListener(media, cart)); // Truyền Media và Cart
	...
	public class ButtonListener implements ActionListener {
	    private Media media; // Media liên quan đến nút
	    private Cart cart;   // Giỏ hàng để thêm Media
	    ...
	    public void actionPerformed(ActionEvent e) {
	        ...
	        if (button.equals("Add to cart")) {
	            ...
	            cart.print(); // In giỏ hàng ra console
	        } 
